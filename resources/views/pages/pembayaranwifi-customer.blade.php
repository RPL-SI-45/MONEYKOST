        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-header pb-0 d-flex align-items-center justify-content-between">
                        ...
                        <button type="button" class="btn btn-outline-info"><a href="{{route('tambah.wifi')}}" class="text-center text-uppercase text-secondary" dusk="submit" name="Beli Paket">Beli Paket</a></button>
                    </div>
